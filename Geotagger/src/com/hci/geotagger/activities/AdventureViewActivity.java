 ...
 * Adventures. Selecting an adventure takes the user to the TagListActivity.
 */
...
{	
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		tabHost.addTab(spec);
		tabHost.getTabWidget().getChildAt(0).setEnabled(false);//disabled temporarily
		
		// hard coding to make text label smaller
		//first checking if tablet or not
		tabHost.getTabWidget().getChildAt(0).getLayoutParams().height =(BaseActivity.isTablet(getBaseContext()))?85:45;
